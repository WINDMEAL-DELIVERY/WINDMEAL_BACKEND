...
public class StoreService {
    ...
    public StoreResponse createStore(StoreCreateRequest request, String imgUrl){
        ...
        categoryRepository.createCategories(request.getCategoryList());//category 에 존재하지 않는 경우 bulk 작업으로 저장
        List<Long> categoryIdList = categoryRepository.findAllByNameIn(request.getCategoryList()).stream()
